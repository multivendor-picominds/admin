...
class PaymentController extends Controller
{
    ...
    public function payWithStripe(Request $request)
    {
        ...
        $is_draft = 'no';
        $order_result = $this->orderStore($user, $total_price, $cartProducts, $totalProduct, 'Stripe', $transaction_id, 1, $shipping, $shipping_fee, $coupon_price, 0, $request->billing_address_id, $request->shipping_address_id, $is_draft);
    ...
    public function razorpayOrder(Request $request)
    {
        ...
        $order_result = $this->orderStore($user, $total_price, $cartProducts, $totalProduct, 'draft', 'draft', 0, $shipping, $shipping_fee, $coupon_price, 0, $request->billing_address_id, $request->shipping_address_id, $is_draft);
    ...
    public function razorpayWebView(Request $request)
    {
        ...
        return view('razorpay_webview', compact('orderId', 'razorpay', 'payable_amount', 'frontend_success_url', 'frontend_faild_url', 'request_from', 'shipping_address_id', 'billing_address_id', 'shipping_method_id', 'coupon', 'token', 'db_order_id'));
    }
    ...
    public function payWithFlutterwave(Request $request)
    {
        ...
        if ($response->status == 'success') {
            ...
            $order_result = $this->orderStore($user, $total_price, $cartProducts, $totalProduct, 'Flutterwave', $transaction_id, 1, $shipping, $shipping_fee, $coupon_price, 0, $request->billing_address_id, $request->shipping_address_id);
    ...
    public function payWithPayStack(Request $request)
    {
        ...
        if ($final_data->status == true) {
            ...
            $transaction_id = $request->tnx_id;
            $order_result = $this->orderStore($user, $total_price, $cartProducts, $totalProduct, 'Paystack', $transaction_id, 1, $shipping, $shipping_fee, $coupon_price, 0, $request->billing_address_id, $request->shipping_address_id);
    ...
    public function sslcommerzWebView(Request $request)
    {
        ...
        return view('sslcommerz_auth_webview', compact('total_price', 'sslcommerzPaymentInfo', 'token'));
    }
    ...
    public function myfatoorah_webview(Request $request)
    {
        ...
        $total = $this->calculateCartTotal($user, 'cartProdcuts', $request->coupon, $request->shipping_method_id);
