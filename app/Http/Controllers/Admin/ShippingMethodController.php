...
class ShippingMethodController extends Controller
{
    ...
    public function updatePerKmPrice(Request $request, $id)
    {
        $rules = [
            'per_km_price_range' => 'required',
        ];
        $customMessages = [
            'per_km_price_range.required' => trans('admin_validation.Per Km Price Range is required'),
        ];
        $this->validate($request, $rules,$customMessages);

        $setting = Setting::find($id);
        $setting->per_km_price_range = $request->per_km_price_range;
        $setting->save();
