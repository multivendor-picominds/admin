...
function payWithPaystack(){
  var handler = PaystackPop.setup({
    ...
    callback: function(response){
      ...
      $.ajax({
          type: "post",
          data: {reference, tnx_id, _token, shipping_address_id, billing_address_id, shipping_method_id, coupon, token, order_id},
          url: "{{ route('user.checkout.guest.pay-with-paystack') }}",
