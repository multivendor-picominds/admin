                            ...
                            <div class="row">
                                <div class="col-12 col-sm-12 col-md-3">
                                    <ul class="nav nav-pills flex-column" id="myTab4" role="tablist">
                                        ...
                                        <li class="nav-item border rounded mb-1">
                                            <a class="nav-link" id="baksh-tab" data-toggle="tab" href="#bakshTab" role="tab" aria-controls="bakshTab" aria-selected="true">{{__('admin.Baksh')}}</a>
                                        </li>
                                ...
                                <div class="col-12 col-sm-12 col-md-9">
                                    <div class="border rounded">
                                        <div class="tab-content no-padding" id="settingsContent">
                                            ...
                                            <div class="tab-pane fade" id="bakshTab" role="tabpanel" aria-labelledby="baksh-tab">
                                                <div class="card m-0">
                                                    <div class="card-body">
                                                        <form action="{{ route('admin.update-baksh') }}" method="POST" enctype="multipart/form-data">
                                                            @csrf
                                                            @method('PUT')
                                                            <div class="form-group">
                                                                <label for="">{{__('admin.Baksh Status')}}</label>
                                                                <div>
                                                                    @if ($baksh->status == 1)
                                                                        <input id="status_toggle" type="checkbox" checked data-toggle="toggle" data-on="{{__('admin.Enable')}}" data-off="{{__('admin.Disable')}}" data-onstyle="success" data-offstyle="danger" name="status">
                                                                        @else
                                                            ...
                                                            <div class="form-group">
                                                                <label for="">{{__('admin.Account Mode')}}</label>
                                                                <select name="account_mode" id="account_mode" class="form-control">
                                                                    <option {{ $baksh->account_mode == 'live' ? 'selected' : '' }} value="live">{{__('admin.Live')}}</option>
                                                                    <option {{ $baksh->account_mode == 'sandbox' ? 'selected' : '' }} value="sandbox">{{__('admin.Sandbox')}}</option>
                                                                </select>
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="">{{ __('admin.Currency Name')}}</label>
                                                                <select name="currency_name" id="" class="form-control select2">
                                                                  ...
                                                                  @foreach ($currencies as $currency)
                                                                  <option {{ $baksh->currency_id == $currency->id ? 'selected' : '' }} value="{{ $currency->id }}">{{ $currency->currency_name }}
                                                                  </option>
                                                                  @endforeach
                                                                </select>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                <label for="">{{__('admin.Baksh User Name')}}</label>
                                                                <input type="text" class="form-control" name="username" value="{{ $baksh->username }}">
                                                            </div>

                                                            <div class="form-group">
                                                                <label for="">{{__('admin.Baksh Password')}}</label>
                                                                <input type="text" class="form-control" name="password" value="{{ $baksh->password }}">
                                                            </div>

                                                            <div class="form-group">
                                                                <label for="">{{__('admin.Baksh App Key')}}</label>
                                                                <input type="text" class="form-control" name="app_key" value="{{ $baksh->app_key }}">
                                                            </div>

                                                            <div class="form-group">
                                                                <label for="">{{__('admin.Baksh App Secret')}}</label>
                                                                <input type="text" class="form-control" name="app_secret" value="{{ $baksh->app_secret }}">
                                                            </div>

                                                            <div class="form-group">
                                                                <label for="">{{__('admin.Current Image')}}</label>
                                                                <div>
                                                                    <img src="{{ asset($baksh->image) }}" width="200px" alt="">
                                                                </div>
                                                            </div>
