                            ...
                            <div class="row">
                                <div class="col-12 col-sm-12 col-md-3">
                                    <ul class="nav nav-pills flex-column" id="myTab4" role="tablist">
                                        ...
                                        <li class="nav-item border rounded mb-1">
                                            <a class="nav-link" id="database-generate-tab" data-toggle="tab" href="#databaseTab" role="tab" aria-controls="databaseTab" aria-selected="true">{{__('Database generate')}}</a>
                                        </li>
                                ...
                                <div class="col-12 col-sm-12 col-md-9">
                                    <div class="border rounded">
                                        <div class="tab-content no-padding" id="settingsContent">
                                                ...
                                                <div class="card m-0">
                                                    <div class="card-body">
                                                      <form action="{{ route('admin.update-general-setting') }}" method="POST" enctype="multipart/form-data">
                                                        ...
                                                        <div class="form-group">
                                                            <label for="">{{__('admin.Google Map')}}</label>
                                                            <select name="map_status" id="" class="form-control">
                                                                <option {{ $setting->map_status == 1 ? 'selected' : '' }} value="1">{{__('admin.Enable')}}</option>
                                                                <option {{ $setting->map_status == 0 ? 'selected' : '' }} value="0">{{__('admin.Disable')}}</option>
                                                            </select>
                                                        </div>
                                                        @if($setting->map_status == 1)
                                                            <div class="form-group">
                                                                <label for="">{{__('admin.Google Map Key')}} </label>
                                                                <input type="text" value="{{ $setting->map_key }}" class="form-control" name="map_key">
                                                            </div>
                                                        @endif
                                                ...
                                                <div class="card m-0">
                                                    <div class="card-body">
                                                        <form action="{{ route('admin.update-theme-color') }}" method="POST">
                                                            ...
                                                            <div class="form-group">
                                                                <label for="">{{__('admin.Secondary color')}}</label>
                                            ...
                                            <div class="tab-pane fade" id="databaseTab" role="tabpanel" aria-labelledby="database-generate-tab">
                                                <div class="card m-0">
                                                    <div class="card-body">
